        ...
        <div class="container-fluid d-flex align-items-center justify-content-between">
          <div class="navbar-header">
            <!-- Navbar Header--><a href="index.html" class="navbar-brand">
              <div class="brand-text brand-big visible text-uppercase"><strong class="text-primary">Aqua</strong><strong>Glam</strong></div>
          ...
          <div class="right-menu list-inline no-margin-bottom">    
            ...
            <!-- Megamenu end     -->
            <!-- Languages dropdown    -->
            {{-- <div class="list-inline-item dropdown"><a id="languages" rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link language dropdown-toggle"><img src="adminasset/img/flags/16/GB.png" alt="English"><span class="d-none d-sm-inline-block">English</span></a>
              <div aria-labelledby="languages" class="dropdown-menu">
                <a rel="nofollow" href="#" class="dropdown-item"> <img src="adminasset/img/flags/16/DE.png" alt="English" class="mr-2"><span>German</span></a><a rel="nofollow" href="#" class="dropdown-item"> <img src="adminasset/img/flags/16/FR.png" alt="English" class="mr-2"><span>French  </span></a></div>
            </div> --}}
            <!-- Log out               -->
            <div class="list-inline-item logout">
              ...
              {{-- <x-app-layout></x-app-layout> --}}
                {{-- <a id="logout" href="{{ route('login') }}" class="nav-link">Logout <i class="icon-logout"></i></a> --}}
            </div>
          </div>
        </div>
      </nav>
